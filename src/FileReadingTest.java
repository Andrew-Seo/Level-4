...
public class FileReadingTest extends TestCase {
	...
	/**
	 * These unit tests will guide you towards making your own encryption
	 * algorithm. Once you get the first test to pass, comment in the next test,
	 * and continue with each subsequent test, one at a time, until you're done.
	 **/
	...
	//
	// assertEquals(stuffToEncrypt,
	// FileEncryptor.decrypt(FileEncryptor.readFileContents(secretFile)));
	// }
